...
window.addEventListener('DOMContentLoaded', async function() {
  ...
  submitButton.addEventListener(`click`, async function(event){
    ...
    if (location.length > 0 ) {
      ...
      let url = `https://api.weatherapi.com/v1/forecast.json?key=44d45d2def604418a9b154001212704&q=${location}&days=3.json`
      ...
      let cityState = document.querySelector(`.current`)
      cityState.innerHTML = `
